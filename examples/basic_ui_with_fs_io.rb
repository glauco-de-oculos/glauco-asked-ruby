      ...
      ui_shell do
        ...
        content(
            ...
            div(
              ...
              bind(:selected, "<div style='width:100%; height:100%; display:flex; align-items:center; justify-content:center;'></div>") do |selected|

                if selected
                  img(
                    src: "http://localhost:8000/files/#{selected.gsub("\\", "/")}",
                    style: "
                      max-width: 100%;
                      max-height: 100%;
                      object-fit: contain;
